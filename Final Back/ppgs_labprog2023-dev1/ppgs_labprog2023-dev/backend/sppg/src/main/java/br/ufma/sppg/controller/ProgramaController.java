...
public class ProgramaController {
    ...
    @GetMapping("/obterGrafico/{idPrograma}/{anoInicial}/{anoFinal}")
    public ResponseEntity<?> ObterGrafico(
        @PathVariable("idPrograma") Integer idPrograma,
        @PathVariable("anoInicial") Integer anoIni,
        @PathVariable("anoFinal") Integer anoFin) {

    var response = servicePPG.obterGrafico(idPrograma, anoIni, anoFin);
    if (response != null) {
        return ResponseEntity.ok(response);
    }
